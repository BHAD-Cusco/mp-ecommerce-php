...
<body class="as-theme-light-heroimage">
  ...
  <div class="as-navtuck-wrapper">
    ...
    <h3>Pago exitoso</h3>
    <h5>payment_method_id : <span><?= $_GET['payment_type'] ?></span></h5>
    <h5>external_reference : <span><?= $_GET['external_reference'] ?></span></h5>
    <h5>payment_id : <span><?= $_GET['collection_id']?></span></h5>
